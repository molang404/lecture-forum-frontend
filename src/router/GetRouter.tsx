...
import AdminCategoryUpdatePage from "../pages/admin/category/edit/AdminCategoryUpdatePage.tsx";
...
const adminLoader = () => {
    ...
    // 이 파일은 컴포넌트가 X, 화면이 그려지기 전 단계의 처리 진행.
    ...
    if (!isLoggedIn) {
        alert("로그인이 필요합니다.");
        // redirect()는, 마찬가지로 컴포넌트가 아닌 곳에서 사용자를 이동 시키는 메서드
